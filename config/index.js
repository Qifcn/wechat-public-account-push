export const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wxf211b752f8606d8c",
  
  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "6742b4b1b5ece05d5f5de1b89c721438",
  ...
  USERS: [
    {
      ...
      id: "oZHU568EYVdqXs37s_nY8-ijTv0w",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "4GJqGnBwLjWuZPpHNq6tItG6iYSmBFqnpzDC4Wh7VF4",
      // 所在省份
      province: "四川",
      // 所在城市
      city: "成都",
